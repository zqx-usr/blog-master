...
import static top.yehonghan.constant.RedisPrefixConst.USER_CODE_KEY;
import static top.yehonghan.util.PageUtils.getSize;
...
public class UserInfoServiceImpl extends ServiceImpl<UserInfoMapper, UserInfo> implements UserInfoService{
    ...
    public void removeOnlineUser(Integer userInfoId) {
        ...
        List<Object> userInfoList = sessionRegistry.getAllPrincipals().stream().filter(item -> {
            UserDetailsImpl userDetails = (UserDetailsImpl) item;
            return userDetails.getUserInfoId().equals(userInfoId);
        }).collect(Collectors.toList());
