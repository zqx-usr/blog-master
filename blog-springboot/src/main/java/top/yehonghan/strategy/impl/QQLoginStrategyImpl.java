...
import top.yehonghan.config.QQConfigProperties;
import top.yehonghan.dto.QQTokenDTO;
import top.yehonghan.dto.QQUserInfoDTO;
...
import top.yehonghan.util.CommonUtils;
import top.yehonghan.vo.QQLoginVO;

import java.util.HashMap;
import java.util.Map;
import java.util.Objects;

import static top.yehonghan.constant.SocialLoginConst.*;
import static top.yehonghan.enums.StatusCodeEnum.QQ_LOGIN_ERROR;
...
public class QQLoginStrategyImpl extends AbstractSocialLoginStrategyImpl {
    ...
    public SocialTokenDTO getSocialToken(String data) {
        ...
        return SocialTokenDTO.builder()
                ...
                .loginType(LoginMethodEnum.QQ.getType())
                .build();
    }
